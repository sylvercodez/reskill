<template>
  ...
  <div class="button ">
    ...
    <q-page-container class="box-par">
      <router-view />
    </q-page-container>
    ...
    <div class="row items-center box-foot">
          <div class="col-md-9 col-sm-6 col-xs-12">
<p class="foot-reskill">
    Reskill Americans, 5608 17th Ave NW, Ste.619 Seattle, WA 98107</p>
